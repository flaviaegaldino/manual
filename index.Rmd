...
The embedding process entails saturating the sample with a liquid compound that solidifies, facilitating subsequent sectioning. The selection of the embedding material depends on the desired thickness of the sections; for thinner sections, a firmer embedding material is required.

**Paraffin**

Paraffin serves as the embedding medium for slicing samples into layers measuring tens of micrometers. Solid at room temperature and with a melting point around 60°C, embedding takes place in a heated stove. Prior to embedding, dehydration is essential due to paraffin's inability to mix with water. After complete infiltration of the sample with paraffin, it is transferred to a mold, filled with paraffin, and allowed to cool to room temperature.

**Resins**

The resins are solidified by polimerization
...
### Dried adherent mammalian cells
...
### Wet adherent mammalian cells

This procedure should be performed chronologically according to the beamtime schedule. Begin by washing the substrates twice by submerging them in 70% ethanol. Place approximately four substrates per well in a 6-well plate. Allow sufficient time for all the ethanol to evaporate completely before seeding the cells. Dispense the cells into the wells and allow them to grow for at least 24 hours.

Avoid using phosphate buffer in this sample preparation. Ensure that the cell confluence reaches a suitable density to cover the substrates without causing overlapping of cell structures during the beamtime. Just before the analysis, transfer one substrate to a 1.5 mL microtube containing cell culture media without FBS using a clamp. Then, at the beamline, transfer the substrate again to a 1.5 mL empty microtube and centrifuge for x minutes. Analyze the substrate immediately after centrifugation.
